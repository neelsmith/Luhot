...
You can use the greekForm and lexemeurn functions to extract these from an Analysis; for a human-readable string value, use the label function on the result. E.g., label the first form in the result:
